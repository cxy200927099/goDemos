...
func main() {
	...
	//a scheme(协议格式), authentication(认证) info, host, port, path, query params, and query fragment.
	...
	//You can also parse query params into a map. The parsed query param
	//maps are from strings to slices of strings, so index into [0]
