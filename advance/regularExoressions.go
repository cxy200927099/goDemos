...
func main() {
	...
	//and the submatches within those matches. For example
	...
	//the MustCompile variation of Compile. A plain Compile won’t work
	// for constants because it has 2 return values.
...
/*
运行： go run regularExpressions.go
结果：
true
true
peach
